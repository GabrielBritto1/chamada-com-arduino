...
<nav x-data="{ open: false }" class="bg-white dark:bg-gray-800 border-b border-gray-100 dark:border-gray-700">
         ...
         <div class="flex">
            ...
            <div class="shrink-0 flex items-center">
               <a href="{{ route('dashboard') }}" wire:navigate>
                  <img src="{{ asset('img/logo_temp_quadrada.png') }}" width="50" class="block fill-current text-gray-800 dark:text-gray-200" />
               </a>
            </div>
            ...
            <div class="hidden space-x-8 sm:-my-px sm:ms-10 sm:flex">
               ...
               <x-nav-link :href="route('scanner.index')" :active="request()->routeIs('scanner.index')" wire:navigate>
                  {{ __('Scanner') }}
               </x-nav-link>
            </div>
         </div>
   ...
   <div :class="{'block': open, 'hidden': ! open}" class="hidden sm:hidden">
      <div class="pt-2 pb-3 space-y-1">
         ...
         <x-responsive-nav-link :href="route('scanner.index')" :active="request()->routeIs('scanner.index')" wire:navigate>
            {{ __('Scanner') }}
         </x-responsive-nav-link>
      </div>
