...
<div>
   ...
   <div class="flex justify-center w-full items-center">
      <div>
         <a href="{{ route('auth.google.redirect') }}" class="flex items-center justify-center py-2 px-20 bg-white hover:bg-gray-200 focus:ring-blue-500 focus:ring-offset-blue-200 text-gray-700 w-full transition ease-in duration-200 text-center text-base font-semibold shadow-md focus:outline-none focus:ring-2 focus:ring-offset-2 rounded-lg">
            <svg
               viewBox="0 0 24 24"
               height="25"
               width="25"
         ...
         <a href="{{ route('auth.github.redirect') }}" class="flex items-center justify-center py-2 px-20 bg-white hover:bg-gray-200 focus:ring-blue-500 focus:ring-offset-blue-200 text-gray-700 w-full transition ease-in duration-200 text-center text-base font-semibold shadow-md focus:outline-none focus:ring-2 focus:ring-offset-2 rounded-lg mt-4">
            <svg
               fill="#000000" viewBox="0 0 24 24" height="25"
            ...
            <span class="ml-2">{{ __('Sign in with') }} GitHub</span>
         </a>
      </div>
   </div>
   ...
   <div class="flex items-center justify-between mt-4">
      ...
      <span class="text-xs text-gray-500 uppercase dark:text-gray-400">{{ __('Don\'t have an account?') }}</span>
      <span class="w-1/5 border-b dark:border-gray-400 md:w-1/4"></span>
   </div>
   <div class="mt-5">
      <button wire:navigate href="{{ route('register') }}" class="py-2 px-4 bg-gray-600 hover:bg-gray-700 focus:ring-gray-500 focus:ring-offset-gray-200 text-white w-full transition ease-in duration-200 text-center text-base font-semibold shadow-md focus:outline-none focus:ring-2 focus:ring-offset-2 rounded-lg">
         {{ __('Register') }}
      </button>
   </div>
</div>